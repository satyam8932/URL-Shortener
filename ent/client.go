...
func (c *LinkClient) UpdateOneID(id int64) *LinkUpdateOne {
...
func (c *LinkClient) DeleteOneID(id int64) *LinkDeleteOne {
...
func (c *LinkClient) Get(ctx context.Context, id int64) (*Link, error) {
	return c.Query().Where(link.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LinkClient) GetX(ctx context.Context, id int64) *Link {
