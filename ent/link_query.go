...
func (_q *LinkQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *LinkQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *LinkQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *LinkQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *LinkQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *LinkQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LinkQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(link.Table, link.Columns, sqlgraph.NewFieldSpec(link.FieldID, field.TypeInt64))
	_spec.From = _q.sql
